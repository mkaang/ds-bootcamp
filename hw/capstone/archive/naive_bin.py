...
tran_train_feat = tran_train_feat_1.append(tran_train_feat_0)
...
tran_train_feat = tran_train_feat.dropna(inplace=True).reset_index(drop=True)
tran_test_feat = tran_test_feat.dropna(inplace=True).reset_index(drop=True)
